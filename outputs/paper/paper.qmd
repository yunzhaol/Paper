---
title: "Toronto's death registry "
author: Yunzhao Li
thanks: "Code and data are available at: [LINK](https://github.com/yunzhaol/Paper.git)."
date: 22 January 2024
abstract: "Interested in the number of death in toronto in 2023. In this project we will make a table of the number of death in Toronto in 2023 to see each month's death registry. By analyzing this table, we can find the months with high number of death and make some connection to several factors like temperature, poicies or incidents of that particular month. The data can also support the City's operational requirements and business functions. "
format: pdf
